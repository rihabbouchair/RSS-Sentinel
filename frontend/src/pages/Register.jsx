      ...
      <div className="gc" style={{ width: '100%', maxWidth: '420px', padding: '32px' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          <div>
            ...
            <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} required placeholder="Choose a username" style={inputStyle} />
          </div>
              ...
              {TOPICS.map((topic) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ fontSize: '12px', color: selected ? color : 'var(--text-secondary)', fontWeight: selected ? '500' : '400' }}>
                      {topic}
                    </span>
                  </label>
                );
